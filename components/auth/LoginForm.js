...
export default function LoginForm({ onForgot, modalMode }) {
  ...
  return (
    <div className={styles.card}>
      ...
      <p className={styles.orText}>hoặc bằng tài khoản riêng</p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.rowBetween}>
          <label className={styles.checkboxLabel}>
            <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} /> Ghi nhớ
          </label>
          <button type="button" className={styles.linkWhite} onClick={onForgot}>Quên mật khẩu?</button>
        </div>
